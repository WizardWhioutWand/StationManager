...
<head>
    ...
    <script  type="text/javascript" src="js/lhgdialog.min.js?skin=iblue"></script>
    ...
    <div id="d2" style="width: 100%;height: 100%">
        ...
        <div>
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    <li>
                        <a href="/web/findByPage?currentPage=${(pb.currentPage-1)<=1?1:(pb.currentPage-1)}" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                    </li>
                    <c:forEach begin="1" end ="${pb.totalPage}" var="i">
                        <li><a href="/web/findByPage?currentPage=${i}">${i}</a></li>
                    </c:forEach>
                    <li>
                        <a href="/web/findByPage?currentPage=${(pb.currentPage+1)>=pb.totalPage?pb.totalPage:(pb.currentPage+1)}" aria-label="Next">
